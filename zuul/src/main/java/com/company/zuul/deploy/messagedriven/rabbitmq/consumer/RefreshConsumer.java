package com.company.zuul.deploy.messagedriven.rabbitmq.consumer;
...
import com.company.zuul.messagedriven.rabbit.utils.ConsumerUtils;
import com.company.zuul.autoconfigure.RabbitMQAutoConfiguration;
