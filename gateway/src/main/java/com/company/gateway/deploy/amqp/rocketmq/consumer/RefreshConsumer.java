package com.company.gateway.deploy.amqp.rocketmq.consumer;

import com.company.gateway.amqp.constants.FanoutConstants;
import com.company.gateway.amqp.constants.HeaderConstants;
import com.company.gateway.amqp.rocketmq.utils.ConsumerUtils;
import com.company.gateway.autoconfigure.RocketMQAutoConfiguration;
...
@RocketMQMessageListener(
        ...
        consumerGroup = "${rocketmq.consumer.group}-" + FanoutConstants.DEPLOY.EXCHANGE + "-${spring.application.name}",
