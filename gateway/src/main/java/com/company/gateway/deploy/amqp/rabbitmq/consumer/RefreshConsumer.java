package com.company.gateway.deploy.amqp.rabbitmq.consumer;

import com.company.gateway.autoconfigure.RabbitAutoConfiguration;
...
import com.company.gateway.amqp.rabbit.utils.ConsumerUtils;
