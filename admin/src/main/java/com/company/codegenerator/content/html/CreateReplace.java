...
public class CreateReplace implements Replace {
	List<Map<String, String>> datas = null;
	String tab;
	
	public CreateReplace(String tab){
	...
	public String doReplace(String src) {
		String input_form_num_tpl = FileUtil.readString("classpath:code-generator-template/jsp/create/input_form_num.jsp", Charset.forName("utf-8"));
		String input_form_select_tpl = FileUtil.readString("classpath:code-generator-template/jsp/create/input_form_select.jsp", Charset.forName("utf-8"));
		String input_form_text_tpl = FileUtil.readString("classpath:code-generator-template/jsp/create/input_form_text.jsp", Charset.forName("utf-8"));
		String input_form_image_tpl = FileUtil.readString("classpath:code-generator-template/jsp/create/input_form_image.jsp", Charset.forName("utf-8"));
