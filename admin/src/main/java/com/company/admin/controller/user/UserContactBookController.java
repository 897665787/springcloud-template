...
public class UserContactBookController {
    ...
    @ResponseBody
    public ? get(UserContactBook userContactBook) {
    ...
    @ResponseBody
    public ? save(@Validated(UserContactBook.Save.class) UserContactBook userContactBook) {
    ...
    @ResponseBody
    public ? remove(UserContactBook userContactBook) {
    ...
    @ResponseBody
    public ? update(@Validated(UserContactBook.Update.class) UserContactBook userContactBook) {
