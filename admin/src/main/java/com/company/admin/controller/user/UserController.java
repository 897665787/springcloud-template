...
public class UserController {
    ...
    @ResponseBody
    public ? save(@Validated(User.MobileUser.class) User user) {
    ...
    @ResponseBody
    public ? update(@Validated(User.MobileUser.class) User user) {
    ...
    @ResponseBody
    public ? updatUserWallet(@Validated(User.UpdateWallet.class) User user, Model model) {
    ...
    @ResponseBody
    public ? updateUserVip(@Validated(User.UpdateVip.class) User user, Model model) {
    ...
    @ResponseBody
    public ? export(User user, HttpServletResponse response) throws Exception {
