...
<c:set var="index" value="marketing_couponUseCondition"/>
<%@include file="../common/content_nav.jsp" %>

<div class="app-content">
    <div class="app-content-body">
        <div class="bg-light lter b-b wrapper-md ">
            <h1 class="m-n font-thin h3 inline">优惠券使用条件</h1>
        </div>
                ...
                <form class="form-horizontal" id="searchForm">
                    <div class="form-group">
                    	...
                    	<div class="col-xs-8 col-md-4 col-lg-3  m-b-md">
                        	<input name="beanName" type="text" class="form-control" placeholder="模糊查询"
                               	value="${search.beanName}">
                    	</div>
                    	<div class="col-xs-4 col-md-2 col-lg-1 no-padder m-b-md text-right">
                        	<label class="control-label">描述：</label>
                    	</div>
                    	<div class="col-xs-8 col-md-4 col-lg-3  m-b-md">
                        	<input name="descrpition" type="text" class="form-control" placeholder="模糊查询"
                               	value="${search.descrpition}">
                    	</div>
                    	<div class="col-xs-4 col-md-2 col-lg-1 no-padder m-b-md text-right">
                    ...
                    <div class="form-group m-t-n-md">
                        <div class="col-xs-12">
                            <sec:authorize access="hasAnyRole(${xs:getPermissions('marketing_couponUseCondition_create')})">
                    ...
                    <table class="table text-center table-bordered table-striped m-b-none">
                        ...
                        <c:forEach items="${pageModel.list}" var="item">
                            <tr>
                                ...
                                <td>
                                    <sec:authorize access="hasAnyRole(${xs:getPermissions('marketing_couponUseCondition_get')})">
                                        <a href="#" onclick="getListItem('${item.id}');return false;"
                                           class="btn btn-success btn-xs">
                                            详情
                                        </a>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${xs:getPermissions('marketing_couponUseCondition_update')})">
                                        <a href="#" onclick="updateListItem('${item.id}');return false;"
                                           class="btn btn-info btn-xs">
                                            编辑
                                        </a>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${xs:getPermissions('marketing_couponUseCondition_delete')})">
                    ...
                    <div class="modal-body">
						<div class="form-group row">
							<div class="col-xs-3 text-right">
								<label class="control-label required">bean名称：</label>
							</div>
							<div class="col-xs-9">
								<input name="beanName" type="text" maxlength="255" class="form-control">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-xs-3 text-right">
							...
							<div class="col-xs-9">
								<input name="descrpition" type="text" maxlength="255" class="form-control">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-xs-3 text-right">
        ...
        var createValidator = $createForm.validate({
			...
			messages: {
				beanName: {
					required: "bean名称不能为空",
					notEmpty: "bean名称不能为空",
					maxlength: "bean名称最多64个字"
				},
			},
            submitHandler: function () {
                $createSubmit.attr("disabled", true);
                doPost("<%=request.getContextPath()%>/admin/marketing/couponUseCondition/save",
                    $createForm.xsJson(),
                    function (data) {
...
<sec:authorize access="hasAnyRole(${xs:getPermissions('marketing_couponUseCondition_get')})">
    ...
    <script>
        ...
        function getListItem(id) {
            doPost("<%=request.getContextPath()%>/admin/marketing/couponUseCondition/get", {id: id}, function (data) {
                if (data.status) {
    ...
    <script>
        ...
        var updateValidator = $updateForm.validate({
            ...
            submitHandler: function () {
                ...
                doPost("<%=request.getContextPath()%>/admin/marketing/couponUseCondition/update", params,
                    function (data) {
    ...
    <script>
        function deleteListItem(id) {
            showDeleteModel(null, function () {
                doPost("<%=request.getContextPath()%>/admin/marketing/couponUseCondition/remove", {id: id}, function (data) {
                    if (data.status) {
