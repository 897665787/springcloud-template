...
<c:set var="index" value="system_city"/>
<%@include file="../common/content_nav.jsp" %>

<div class="app-content ">
    <div class="app-content-body">
        <div class="bg-light lter b-b wrapper-md ">
            <h1 class="m-n font-thin h3 inline">城市管理</h1>
        </div>
            ...
            <div class="col-xs-12">
                <form class="form-horizontal" id="searchForm" name="searchForm">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8 col-md-4 col-lg-3  m-b-md">
                        	<select id="searchProvinceId" name="province.id" class="form-control" data-current-value="${search.province.id}"></select>
                        </div>
                    </div>
                    <div class="form-group m-t-n-md">
                        <div class="col-xs-12">
                            <sec:authorize access="hasAnyRole(${xs:getPermissions('system_city_create')})">
                        ...
                        <c:forEach items="${pageModel.list}" var="item">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <sec:authorize access="hasAnyRole(${xs:getPermissions('system_city_update')})">
                                        <a href="#" onclick="updateListItem('${item.id}');return false;"
                                           class="btn btn-info btn-xs">
                                            编辑
                                        </a>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${xs:getPermissions('system_city_delete')})">
                                        <a href="#" class="btn btn-danger btn-xs"
                ...
                <form name="createForm" class="form-horizontal" style="max-width: 800px">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <select id="createProvinceId" name="province.id" class="form-control"></select>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        var createValidator = $createForm.validate({
            ...
            submitHandler: function () {
                ...
                doPost("<%=request.getContextPath()%>/admin/system/city/save",
                ...
                <form name="updateForm" class="form-horizontal" style="max-width: 800px">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <select id="updateProvinceId" name="province.id" class="form-control"></select>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        ...
        var updateValidator = $updateForm.validate({
            ...
            submitHandler: function () {
                ...
                doPost("<%=request.getContextPath()%>/admin/system/city/update",
        ...
        function updateListItem(id) {
            doPost("<%=request.getContextPath()%>/admin/system/city/get", {id: id}, function (data) {
                if (data.status) {
...
<sec:authorize access="hasAnyRole(${xs:getPermissions('system_city_status')})">
    <script>
        function updateListItemStatus(selectedId, status) {
            doPost("<%=request.getContextPath()%>/admin/system/city/status/update",
                {
                    id: selectedId,
                    status: status
                },
        ...
        function updateListItemChildrenStatus(selectedId, status) {
            doPost("<%=request.getContextPath()%>/admin/system/city/district/status/update",
                {
                    id: selectedId,
                    status: status
                },
    ...
    <script>
        function deleteListItem(id) {
            showDeleteModel(null, function () {
                doPost("<%=request.getContextPath()%>/admin/system/city/remove", {id: id}, function (data) {
                    if (data.status) {
                        setTimeout(function () {
