...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_7lwiu5ynjn6umooc.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_7lwiu5ynjn6umooc.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_7lwiu5ynjn6umooc.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_bxoriysjn6umoos = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_bxoriysjn6umoos.browsers();
    var oses = $_bxoriysjn6umoos.oses();
    var browser = $_3pub70yqjn6umook.detectBrowser(browsers, userAgent).fold($_mglutymjn6umoo8.unknown, $_mglutymjn6umoo8.nu);
    var os = $_3pub70yqjn6umook.detectOs(oses, userAgent).fold($_djcbypyojn6umood.unknown, $_djcbypyojn6umood.nu);
  ...
  var $_4gpp8kyljn6umoo6 = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_4gpp8kyljn6umoo6.detect(userAgent);
  });
  var $_g950fwyijn6umons = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_g950fwyijn6umons.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_cw2kzbz0jn6umoq5.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_cw2kzbz0jn6umoq5.ELEMENT);
  var isText = isType$1($_cw2kzbz0jn6umoq5.TEXT);
  var isDocument = isType$1($_cw2kzbz0jn6umoq5.DOCUMENT);
  var $_gct936yzjn6umoq4 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_gct936yzjn6umoq4.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_awqhvz7jn6umoqv = { toArray: toArray };
  ...
  var $_9nn2kgzajn6umor7 = { getOrDie: getOrDie };

  var node = function () {
    var f = $_9nn2kgzajn6umor7.getOrDie('Node');
    return f;
  };
  ...
  var $_dcsx23z9jn6umor6 = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_cw2kzbz0jn6umoq5.ELEMENT;
  var DOCUMENT = $_cw2kzbz0jn6umoq5.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_dcsx23z9jn6umor6.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_g950fwyijn6umons.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_85wxrz8jn6umoqw = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_bz2z3jzdjn6umorc.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_85wxrz8jn6umoqw.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_85wxrz8jn6umoqw.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_awqhvz7jn6umoqv.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_awqhvz7jn6umoqv.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_dazinbz2jn6umoq9.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_dazinbz2jn6umoq9.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_dazinbz2jn6umoq9.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_dazinbz2jn6umoq9.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_9nc3b5z1jn6umoq7.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_9nc3b5z1jn6umoq7.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_9nc3b5z1jn6umoq7.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_9nc3b5z1jn6umoq7.append(parent, x);
    });
  };
  var $_a50709zfjn6umoro = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_dazinbz2jn6umoq9.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_dazinbz2jn6umoq9.children(wrapper);
    if (children.length > 0)
      $_a50709zfjn6umoro.before(wrapper, children);
    remove(wrapper);
  };
  var $_3m3d03zejn6umork = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_9nc3b5z1jn6umoq7.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_9dg7dyyxjn6umopr.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_3m3d03zejn6umork.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_dazinbz2jn6umoq9.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_3m3d03zejn6umork.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_9nc3b5z1jn6umoq7.append(element, guiSystem.element());
    var children = $_dazinbz2jn6umoq9.children(guiSystem.element());
  ...
  var json = function () {
    return $_9nn2kgzajn6umor7.getOrDie('JSON');
  };
  ...
  var $_6ax7lyzwjn6umov7 = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_6ax7lyzwjn6umov7.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_85wxrz8jn6umoqw.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_6ax7lyzwjn6umov7.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_6ax7lyzwjn6umov7.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_6ax7lyzwjn6umov7.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_gct936yzjn6umoq4.isElement(source) || !$_gct936yzjn6umoq4.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_dva6zk10bjn6umoyj = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_dva6zk10bjn6umoyj.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_dva6zk10bjn6umoyj.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_dva6zk10bjn6umoyj.remove(element, attr);
    return false;
  };
  var $_ck2yhr10djn6umoyx = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_ck2yhr10djn6umoyx.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_ck2yhr10djn6umoyx.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_ck2yhr10djn6umoyx.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_3ls0t010cjn6umoyt.supports(element))
      element.dom().classList.add(clazz);
    else
      $_3ls0t010cjn6umoyt.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_3ls0t010cjn6umoyt.supports(element) ? element.dom().classList : $_3ls0t010cjn6umoyt.get(element);
    if (classList.length === 0) {
      $_dva6zk10bjn6umoyj.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_3ls0t010cjn6umoyt.supports(element)) {
      ...
      $_3ls0t010cjn6umoyt.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_3ls0t010cjn6umoyt.supports(element) ? element.dom().classList.toggle(clazz) : $_3ls0t010cjn6umoyt.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_3ls0t010cjn6umoyt.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_3ls0t010cjn6umoyt.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_759bvl109jn6umoyh = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_759bvl109jn6umoyh.remove(element, removeCls);
    $_759bvl109jn6umoyh.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_759bvl109jn6umoyh.remove(component.element(), swapConfig.alpha());
    $_759bvl109jn6umoyh.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_759bvl109jn6umoyh.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_759bvl109jn6umoyh.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_9dg7dyyxjn6umopr.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_85wxrz8jn6umoqw.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_et9nvq10ijn6umozg.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_et9nvq10ijn6umozg.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_et9nvq10ijn6umozg.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_et9nvq10ijn6umozg.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_et9nvq10ijn6umozg.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_et9nvq10ijn6umozg.descendant(scope, predicate).isSome();
  };
  var $_sx3ro10hjn6umozf = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_dazinbz2jn6umoq9.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_dazinbz2jn6umoq9.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_sx3ro10hjn6umozf.closest(a, curry($_85wxrz8jn6umoqw.eq, element));
    });
  ...
  var search = function (element) {
    return active($_dazinbz2jn6umoq9.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_c6hzqn10gjn6umoz8 = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_2z1q2x10mjn6umozz = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_dazinbz2jn6umoq9.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_dazinbz2jn6umoq9.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_mzus010vjn6ump15.fromHtml(content, docDom);
    $_a50709zfjn6umoro.append(fragment, contentElements);
    $_3m3d03zejn6umork.empty(element);
    $_9nc3b5z1jn6umoq7.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_9nc3b5z1jn6umoq7.append(container, clone);
    return get$2(container);
  };
  var $_8peqn910ujn6ump14 = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_dva6zk10bjn6umoyj.clone(original);
    $_dva6zk10bjn6umoyj.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_dazinbz2jn6umoq9.children(deep$1(original));
    $_a50709zfjn6umoro.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_9nc3b5z1jn6umoq7.before(original, nu);
    var children = $_dazinbz2jn6umoq9.children(original);
    $_a50709zfjn6umoro.append(nu, children);
    $_3m3d03zejn6umork.remove(original);
    return nu;
  };
  var $_gegopr10wjn6ump1d = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_gegopr10wjn6ump1d.shallow(element);
    return $_8peqn910ujn6ump14.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_759bvl109jn6umoyh.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_759bvl109jn6umoyh.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_759bvl109jn6umoyh.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_759bvl109jn6umoyh.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_dva6zk10bjn6umoyj.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_dva6zk10bjn6umoyj.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_dva6zk10bjn6umoyj.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_dva6zk10bjn6umoyj.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_gbgiqz10ojn6ump03.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_gbgiqz10ojn6ump03.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_g950fwyijn6umons.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_c6hzqn10gjn6umoz8.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_c6hzqn10gjn6umoz8.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_c6hzqn10gjn6umoz8.hasFocus(component.element());
  };
  ...
  var $_ggb2co11mjn6ump6x = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_ggb2co11mjn6ump6x.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_9dg7dyyxjn6umopr.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_ggb2co11mjn6ump6x.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_dva6zk10bjn6umoyj.has(element, 'style') && trim($_dva6zk10bjn6umoyj.get(element, 'style')) === '') {
      $_dva6zk10bjn6umoyj.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_dva6zk10bjn6umoyj.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_dva6zk10bjn6umoyj.remove : $_dva6zk10bjn6umoyj.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_ggb2co11mjn6ump6x.isSupported(sourceDom) && $_ggb2co11mjn6ump6x.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_4rxiy211ljn6ump6j.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_4rxiy211ljn6ump6j.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_9dg7dyyxjn6umopr.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_4rxiy211ljn6ump6j.set(element, 'max-height', absMax + 'px');
  };
  var $_mj8311kjn6ump6h = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_9dg7dyyxjn6umopr.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_dazinbz2jn6umoq9.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_dazinbz2jn6umoq9.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_dazinbz2jn6umoq9.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_dazinbz2jn6umoq9.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_bz2z3jzdjn6umorc.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_btc7h711pjn6ump76.ancestors(scope, function (e) {
      return $_bz2z3jzdjn6umorc.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_btc7h711pjn6ump76.siblings(scope, function (e) {
      return $_bz2z3jzdjn6umorc.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_btc7h711pjn6ump76.children(scope, function (e) {
      return $_bz2z3jzdjn6umorc.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_bz2z3jzdjn6umorc.all(selector, scope);
  };
  var $_1dzk3z11ojn6ump75 = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_bz2z3jzdjn6umorc.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_et9nvq10ijn6umozg.ancestor(scope, function (e) {
      return $_bz2z3jzdjn6umorc.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_et9nvq10ijn6umozg.sibling(scope, function (e) {
      return $_bz2z3jzdjn6umorc.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_et9nvq10ijn6umozg.child(scope, function (e) {
      return $_bz2z3jzdjn6umorc.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_bz2z3jzdjn6umorc.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_bz2z3jzdjn6umorc.is, ancestor$2, scope, selector, isRoot);
  };
  var $_3zl4ya11qjn6ump79 = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_1dzk3z11ojn6ump75.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_759bvl109jn6umoyh.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_759bvl109jn6umoyh.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_759bvl109jn6umoyh.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_1dzk3z11ojn6ump75.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_759bvl109jn6umoyh.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_3zl4ya11qjn6ump79.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_3zl4ya11qjn6ump79.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_759bvl109jn6umoyh.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_c6hzqn10gjn6umoz8.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_3zl4ya11qjn6ump79.closest(element, sel);
      }).getOr(element);
      return $_mj8311kjn6ump6h.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_1dzk3z11ojn6ump75.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_3zl4ya11qjn6ump79.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_85wxrz8jn6umoqw.eq, tabstop));
  ...
  var inside = function (target) {
    return $_gct936yzjn6umoq4.name(target) === 'input' && $_dva6zk10bjn6umoyj.get(target, 'type') !== 'radio' || $_gct936yzjn6umoq4.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_4rxiy211ljn6ump6j.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_cs2oi4128jn6umpan = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_cs2oi4128jn6umpan.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_cs2oi4128jn6umpan.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_4rxiy211ljn6ump6j.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_4rxiy211ljn6ump6j.set, element, property, initial);
    var on = curry($_4rxiy211ljn6ump6j.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_3sclgd12ajn6umpb2.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_85wxrz8jn6umoqw.eq, current);
    var candidates = $_1dzk3z11ojn6ump75.descendants(container, selector);
    var visible = filter(candidates, $_3sclgd12ajn6umpb2.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_85wxrz8jn6umoqw.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_3zl4ya11qjn6ump79.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_3zl4ya11qjn6ump79.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_3zl4ya11qjn6ump79.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_3zl4ya11qjn6ump79.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_3zl4ya11qjn6ump79.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_c6hzqn10gjn6umoz8.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_1dzk3z11ojn6ump75.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_3zl4ya11qjn6ump79.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_1dzk3z11ojn6ump75.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_1dzk3z11ojn6ump75.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_3zl4ya11qjn6ump79.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_6ax7lyzwjn6umov7.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_6ax7lyzwjn6umov7.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_dva6zk10bjn6umoyj.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_dva6zk10bjn6umoyj.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_gct936yzjn6umoq4.isElement(elem) ? $_dva6zk10bjn6umoyj.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_dazinbz2jn6umoq9.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_8peqn910ujn6ump14.get(elem) };
    return deepMerge({
      tag: $_gct936yzjn6umoq4.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_9ajkhl118jn6ump4b.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_9ajkhl118jn6ump4b.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_9eogv9117jn6ump46.format(command, function (button, status) {
  ...
  var isTouch = $_g950fwyijn6umons.detect().deviceType.isTouch();
  ...
  var platform = $_g950fwyijn6umons.detect();
  ...
  var isTouch$2 = $_g950fwyijn6umons.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_4rxiy211ljn6ump6j.set(element, 'max-width', absMax + 'px');
  };
  var $_cta6ru13fjn6umplv = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_g950fwyijn6umons.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_cta6ru13fjn6umplv.get(thumb.element()) / 2;
      $_4rxiy211ljn6ump6j.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_4rxiy211ljn6ump6j.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_enpctv119jn6ump4e.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_4rxiy211ljn6ump6j.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_9ajkhl118jn6ump4b.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_9eogv9117jn6ump46.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_9ajkhl118jn6ump4b.resolve('slider-' + spec$$1.category + '-size-container'),
          $_9ajkhl118jn6ump4b.resolve('slider'),
          $_9ajkhl118jn6ump4b.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_bfacge13ijn6umplz = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_gct936yzjn6umoq4.isElement(rawStart) ? Option.some(rawStart) : $_dazinbz2jn6umoq9.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_et9nvq10ijn6umozg.closest(start, function (elem) {
        return $_4rxiy211ljn6ump6j.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_4rxiy211ljn6ump6j.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_4rxiy211ljn6ump6j.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_85wxrz8jn6umoqw.eq(root, e);
    };
  ...
  var $_1bld5813jjn6umpmc = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_1bld5813jjn6umpmc.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_bfacge13ijn6umplz.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_1bld5813jjn6umpmc.apply(editor, value);
      },
      getInitialValue: function () {
        return $_1bld5813jjn6umpmc.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_9nn2kgzajn6umor7.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_9nn2kgzajn6umor7.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_9nn2kgzajn6umor7.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_9nn2kgzajn6umor7.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_9nn2kgzajn6umor7.getOrDie('atob');
    return f(base64);
  };
  var $_2tdtjz13ujn6umpoc = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_2tdtjz13ujn6umpoc.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_5xgbb213ojn6umpo2.create($_4qpjfz13pjn6umpo3.getWidth(image), $_4qpjfz13pjn6umpo3.getHeight(image));
      context = $_5xgbb213ojn6umpo2.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_eialyh13njn6umpnn.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_eialyh13njn6umpnn.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_eialyh13njn6umpnn.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_eialyh13njn6umpnn.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_eialyh13njn6umpnn.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_eialyh13njn6umpnn.uriToBlob(uri));
  };
  var $_f2njze13mjn6umpni = {
  ...
  var addImage = function (editor, blob) {
    $_f2njze13mjn6umpni.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_ghyytn13xjn6umpoy.get(link);
    var url = $_dva6zk10bjn6umoyj.get(link, 'href');
    var title = $_dva6zk10bjn6umoyj.get(link, 'title');
    var target = $_dva6zk10bjn6umoyj.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_dva6zk10bjn6umoyj.get(link, 'href');
    var prevText = $_ghyytn13xjn6umpoy.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_dva6zk10bjn6umoyj.setAll(link, attrs);
        text.each(function (newText) {
          $_ghyytn13xjn6umpoy.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_3zl4ya11qjn6ump79.closest(start, 'a');
  };
  var $_7wlstn13wjn6umpol = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_g950fwyijn6umons.detect();
  ...
  var $_5qfcdt13yjn6umpoz = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_bbf3w3148jn6umprh.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_bbf3w3148jn6umprh.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_bbf3w3148jn6umprh.get(input.element());
            if (current !== data) {
              $_bbf3w3148jn6umprh.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_9ajkhl118jn6ump4b.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_gct936yzjn6umoq4.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_dva6zk10bjn6umoyj.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_dva6zk10bjn6umoyj.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_dva6zk10bjn6umoyj.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_dva6zk10bjn6umoyj.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_dva6zk10bjn6umoyj.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_dva6zk10bjn6umoyj.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_759bvl109jn6umoyh.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_759bvl109jn6umoyh.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_9ajkhl118jn6ump4b.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_3zl4ya11qjn6ump79.descendant(dialog.element(), '.' + $_9ajkhl118jn6ump4b.resolve('serialised-dialog-chain')).each(function (parent) {
        $_4rxiy211ljn6ump6j.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_1dzk3z11ojn6ump75.descendants(dialog.element(), '.' + $_9ajkhl118jn6ump4b.resolve('serialised-dialog-screen'));
      $_3zl4ya11qjn6ump79.descendant(dialog.element(), '.' + $_9ajkhl118jn6ump4b.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_4rxiy211ljn6ump6j.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_cta6ru13fjn6umplv.get(screens[0]);
            $_4rxiy211ljn6ump6j.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_1dzk3z11ojn6ump75.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_9eogv9117jn6ump46.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_9ajkhl118jn6ump4b.resolve('dot-active'),
          itemClass: $_9ajkhl118jn6ump4b.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_7z8dpk14jjn6umpu2.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_7z8dpk14jjn6umpu2.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_7z8dpk14jjn6umpu2.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_7wlstn13wjn6umpol.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_7wlstn13wjn6umpol.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_enpctv119jn6ump4e.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_5qfcdt13yjn6umpoz.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_7wlstn13wjn6umpol.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_85wxrz8jn6umoqw.eq(originator, component.element()) && !$_85wxrz8jn6umoqw.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_6ax7lyzwjn6umov7.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_6ax7lyzwjn6umov7.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_6ax7lyzwjn6umov7.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_6ax7lyzwjn6umov7.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_6ax7lyzwjn6umov7.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_759bvl109jn6umoyh.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_759bvl109jn6umoyh.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_759bvl109jn6umoyh.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_759bvl109jn6umoyh.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_3ls0t010cjn6umoyt.supports(element) ? getNative(element) : $_3ls0t010cjn6umoyt.get(element);
  };
  var $_bvg4jv151jn6umq0p = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_dva6zk10bjn6umoyj.setAll(subject, definition.attributes().getOr({}));
    $_bvg4jv151jn6umq0p.add(subject, definition.classes().getOr([]));
    $_4rxiy211ljn6ump6j.setAll(subject, definition.styles().getOr({}));
    $_8peqn910ujn6ump14.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_a50709zfjn6umoro.append(subject, children);
    definition.value().each(function (value) {
      $_bbf3w3148jn6umprh.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_dazinbz2jn6umoq9.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_6ax7lyzwjn6umov7.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_c6hzqn10gjn6umoz8.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_dazinbz2jn6umoq9.owner(container);
    var refocus = $_c6hzqn10gjn6umoz8.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_85wxrz8jn6umoqw.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_et9nvq10ijn6umozg.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_c6hzqn10gjn6umoz8.active(ownerDoc).filter(function (newFocus) {
        return $_85wxrz8jn6umoqw.eq(newFocus, oldFocus);
      }).fold(function () {
        $_c6hzqn10gjn6umoz8.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_9nc3b5z1jn6umoq7.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_9nc3b5z1jn6umoq7.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_85wxrz8jn6umoqw.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_759bvl109jn6umoyh.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_9dg7dyyxjn6umopr.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_bvg4jv151jn6umq0p.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_bvg4jv151jn6umq0p.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_3zl4ya11qjn6ump79.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_759bvl109jn6umoyh.remove(comp.element(), t.transitionClass());
      $_dva6zk10bjn6umoyj.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_dva6zk10bjn6umoyj.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_dva6zk10bjn6umoyj.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_dva6zk10bjn6umoyj.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_dva6zk10bjn6umoyj.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_dva6zk10bjn6umoyj.has(comp.element(), transConfig.stateAttr()) && $_dva6zk10bjn6umoyj.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_dva6zk10bjn6umoyj.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_dva6zk10bjn6umoyj.has(comp.element(), transConfig.destinationAttr())) {
      $_dva6zk10bjn6umoyj.set(comp.element(), transConfig.stateAttr(), $_dva6zk10bjn6umoyj.get(comp.element(), transConfig.destinationAttr()));
      $_dva6zk10bjn6umoyj.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_759bvl109jn6umoyh.add(comp.element(), t.transitionClass());
      $_dva6zk10bjn6umoyj.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_dva6zk10bjn6umoyj.has(e, transConfig.stateAttr()) ? Option.some($_dva6zk10bjn6umoyj.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_9ajkhl118jn6ump4b.resolve('scrollable');
  var register = function (element) {
    $_759bvl109jn6umoyh.add(element, scrollable);
  };
  var deregister = function (element) {
    $_759bvl109jn6umoyh.remove(element, scrollable);
  };
  var $_21vyir15ojn6umq6w = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_9ajkhl118jn6ump4b.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_9ajkhl118jn6ump4b.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_9eogv9117jn6ump46.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_9ajkhl118jn6ump4b.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_9ajkhl118jn6ump4b.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_9ajkhl118jn6ump4b.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_4rxiy211ljn6ump6j.set(component.element(), 'overflow-y', 'auto');
                $_4rxiy211ljn6ump6j.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_21vyir15ojn6umq6w.register(component.element());
              }),
              runOnDetached(function (component) {
                $_4rxiy211ljn6ump6j.remove(component.element(), 'overflow-y');
                $_4rxiy211ljn6ump6j.remove(component.element(), '-webkit-overflow-scrolling');
                $_21vyir15ojn6umq6w.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_9ajkhl118jn6ump4b.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_cta6ru13fjn6umplv.get(container.element());
        $_cta6ru13fjn6umplv.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_cta6ru13fjn6umplv.get(container.element());
        var menu = $_3zl4ya11qjn6ump79.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_cta6ru13fjn6umplv.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_3zl4ya11qjn6ump79.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_9ajkhl118jn6ump4b.resolve('styles-background-menu'),
        menu: $_9ajkhl118jn6ump4b.resolve('styles-menu'),
        selectedMenu: $_9ajkhl118jn6ump4b.resolve('styles-selected-menu'),
        item: $_9ajkhl118jn6ump4b.resolve('styles-item'),
        selectedItem: $_9ajkhl118jn6ump4b.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_f1mc0x14mjn6umpuk = { sketch: sketch$9 };
  ...
  var $_e6pbmj15pjn6umq73 = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_e6pbmj15pjn6umq73.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_f1mc0x14mjn6umpuk.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_enpctv119jn6ump4e.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_enpctv119jn6ump4e.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_enpctv119jn6ump4e.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_5xdl3l12zjn6umpip.sketch(realm, editor);
    };
    var styleFormats = $_bsxse414kjn6umpu4.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_bsxse414kjn6umpu4.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_enpctv119jn6ump4e.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_9eogv9117jn6ump46.receive($_gbgiqz10ojn6ump03.orientationChanged(), Toggling.off),
            $_9eogv9117jn6ump46.receive($_gbgiqz10ojn6ump03.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_4epx8715sjn6umq7p.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_4epx8715sjn6umq7p.capture(element, event, filter$1, handler);
  };
  var $_48e6gz15rjn6umq7l = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_g950fwyijn6umons.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_48e6gz15rjn6umq7l.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_85wxrz8jn6umoqw.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_48e6gz15rjn6umq7l.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_48e6gz15rjn6umq7l.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_ftfvbk15xjn6umq8z = { monitor: monitor$1 };

  var isAndroid6 = $_g950fwyijn6umons.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_ftfvbk15xjn6umq8z.monitor(editorApi);
    var outerDoc = $_dazinbz2jn6umoq9.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_85wxrz8jn6umoqw.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_c6hzqn10gjn6umoz8.active(outerDoc).filter(function (input) {
        return $_gct936yzjn6umoq4.name(input) === 'input';
    ...
    var listeners = [
      $_48e6gz15rjn6umq7l.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_48e6gz15rjn6umq7l.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_c6hzqn10gjn6umoz8.blur(editorApi.body());
      }),
      ...
      $_48e6gz15rjn6umq7l.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_48e6gz15rjn6umq7l.bind(outerDoc, 'select', updateMargin),
      $_48e6gz15rjn6umq7l.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_a0i73v15wjn6umq8f = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_dva6zk10bjn6umoyj.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_cegosv161jn6umqa4 = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_gct936yzjn6umoq4.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_gct936yzjn6umoq4.name(element) === 'img' ? 1 : $_6nhwj6164jn6umqao.getOption(element).fold(function () {
      return $_dazinbz2jn6umoq9.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_6nhwj6164jn6umqao.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_gct936yzjn6umoq4.name(elem));
  };
  var $_cxogcg163jn6umqak = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_893mfx167jn6umqb1.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_dazinbz2jn6umoq9.defaultView(start);
  };
  var $_b1e61k166jn6umqav = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_dazinbz2jn6umoq9.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_85wxrz8jn6umoqw.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_6xrmss169jn6umqbf = {
    after: after$2,
  ...
  var $_e1iuz116ajn6umqbg = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_79gmzb16bjn6umqbl.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_79gmzb16bjn6umqbl.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_79gmzb16bjn6umqbl.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_79gmzb16bjn6umqbl.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_6nhwj6164jn6umqao.get(textnode).length;
    var offset = $_e8y1js16fjn6umqce.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_e8y1js16fjn6umqce.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_4xhfk116gjn6umqcf = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_dazinbz2jn6umoq9.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_e8y1js16fjn6umqce.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_gct936yzjn6umoq4.isText(node) ? $_4xhfk116gjn6umqcf.locate : searchInChildren;
  ...
  var $_f6ho6616ejn6umqc8 = { locate: locate$2 };

  var first$3 = function (element) {
    return $_et9nvq10ijn6umozg.descendant(element, $_cxogcg163jn6umqak.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_cxogcg163jn6umqak.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_dazinbz2jn6umoq9.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_2alp7816ijn6umqcp.first : $_2alp7816ijn6umqcp.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_dazinbz2jn6umoq9.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_4bjj7716hjn6umqcl = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_f6ho6616ejn6umqc8.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_4bjj7716hjn6umqcl.search(doc, elem, x);
      };
      return $_dazinbz2jn6umoq9.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_b1e61k166jn6umqav.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_ah8ar416djn6umqc3 = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_79gmzb16bjn6umqbl.create(win);
    var self = $_bz2z3jzdjn6umorc.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_1dzk3z11ojn6ump75.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_79gmzb16bjn6umqbl.selectNodeContentsUsing(innerRange, elem);
      return $_79gmzb16bjn6umqbl.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_ezmwou16cjn6umqbs.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_gct936yzjn6umoq4.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_32gncf16jjn6umqct = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_gct936yzjn6umoq4.name(element);
    if ('input' === name)
      return $_893mfx167jn6umqb1.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_893mfx167jn6umqb1.on(element, offset);
    else
      return offset === 0 ? $_893mfx167jn6umqb1.before(element) : $_893mfx167jn6umqb1.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_893mfx167jn6umqb1.before, beforeSpecial, $_893mfx167jn6umqb1.after);
    var finish = finishSitu.fold($_893mfx167jn6umqb1.before, beforeSpecial, $_893mfx167jn6umqb1.after);
    return $_b1e61k166jn6umqav.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_b1e61k166jn6umqav.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_79gmzb16bjn6umqbl.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_32gncf16jjn6umqct.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_ezmwou16cjn6umqbs.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_o6t6u16kjn6umqcx.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_o6t6u16kjn6umqcx.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_b1e61k166jn6umqav.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_79gmzb16bjn6umqbl.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_o6t6u16kjn6umqcx.preprocess(selection);
    return $_ezmwou16cjn6umqbs.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_b1e61k166jn6umqav.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_6xrmss169jn6umqbf.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_b1e61k166jn6umqav.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_79gmzb16bjn6umqbl.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_b1e61k166jn6umqav.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_ezmwou16cjn6umqbs.asLtrRange(win, selection);
    return $_79gmzb16bjn6umqbl.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_ezmwou16cjn6umqbs.asLtrRange(win, selection);
    return $_79gmzb16bjn6umqbl.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_ah8ar416djn6umqc3.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_ezmwou16cjn6umqbs.asLtrRange(win, selection);
    return $_79gmzb16bjn6umqbl.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_ezmwou16cjn6umqbs.asLtrRange(win, selection);
    return $_79gmzb16bjn6umqbl.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_ezmwou16cjn6umqbs.asLtrRange(win, selection);
    var fragment = $_e1iuz116ajn6umqbg.fromElements(elements, win.document);
    $_79gmzb16bjn6umqbl.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_ezmwou16cjn6umqbs.asLtrRange(win, selection);
    $_79gmzb16bjn6umqbl.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_85wxrz8jn6umoqw.eq(start, finish) && soffset === foffset;
  };
  var $_6xiqi8168jn6umqb9 = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_dazinbz2jn6umoq9.parent(start_1).bind(function (parent) {
        var selection = $_b1e61k166jn6umqav.exact(start_1, range$$1.startOffset, parent, $_cxogcg163jn6umqak.getEnd(parent));
        var optRect = $_6xiqi8168jn6umqb9.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_hj8bs162jn6umqa6 = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_c6hzqn10gjn6umoz8.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_gct936yzjn6umoq4.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_c6hzqn10gjn6umoz8.active().each($_c6hzqn10gjn6umoz8.blur);
      $_c6hzqn10gjn6umoz8.focus(iBody);
    });
  };
  var $_66zh3w16ljn6umqd4 = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_9ajkhl118jn6ump4b.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_dva6zk10bjn6umoyj.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_cegosv161jn6umqa4.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_hj8bs162jn6umqa6.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_66zh3w16ljn6umqd4.resume(cWin);
    };
    var onResize = $_48e6gz15rjn6umq7l.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_1juhar160jn6umq9s = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_6xiqi8168jn6umqb9.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_48e6gz15rjn6umq7l.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_6xiqi8168jn6umqb9.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_6xiqi8168jn6umqb9.get(win).bind(function (sel) {
                return $_6xiqi8168jn6umqb9.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_6xiqi8168jn6umqb9.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_6xiqi8168jn6umqb9.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_g950fwyijn6umons.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_4rxiy211ljn6ump6j.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_1dzk3z11ojn6ump75.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_dva6zk10bjn6umoyj.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_dva6zk10bjn6umoyj.set(element, attr, backup);
          $_dva6zk10bjn6umoyj.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_1dzk3z11ojn6ump75.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_1dzk3z11ojn6ump75.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_dva6zk10bjn6umoyj.get(element, attr);
      if (restore !== 'no-styles') {
        $_dva6zk10bjn6umoyj.set(element, 'style', restore);
      } else {
        $_dva6zk10bjn6umoyj.remove(element, 'style');
      }
      $_dva6zk10bjn6umoyj.remove(element, attr);
  ...
  var $_826n2m16njn6umqdt = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_3zl4ya11qjn6ump79.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_dva6zk10bjn6umoyj.set(meta, 'name', 'viewport');
      $_9nc3b5z1jn6umoq7.append(head, meta);
      return meta;
    };
    var element = $_3zl4ya11qjn6ump79.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_dva6zk10bjn6umoyj.get(element, 'content');
    var maximize = function () {
      $_dva6zk10bjn6umoyj.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_dva6zk10bjn6umoyj.set(element, 'content', backup);
      } else {
        $_dva6zk10bjn6umoyj.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_4nuq9116ojn6umqe3 = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_4nuq9116ojn6umqe3.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_759bvl109jn6umoyh.add(platform.container, $_9ajkhl118jn6ump4b.resolve('fullscreen-maximized'));
      $_759bvl109jn6umoyh.add(platform.container, $_9ajkhl118jn6ump4b.resolve('android-maximized'));
      meta.maximize();
      $_759bvl109jn6umoyh.add(platform.body, $_9ajkhl118jn6ump4b.resolve('android-scroll-reload'));
      androidApi.set($_1juhar160jn6umq9s.setup(platform.win, $_a9ikzi16mjn6umqdf.getWin(platform.editor).getOrDie('no')));
      $_a9ikzi16mjn6umqdf.getActiveApi(platform.editor).each(function (editorApi) {
        $_826n2m16njn6umqdt.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_a0i73v15wjn6umq8f.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_759bvl109jn6umoyh.remove(platform.container, $_9ajkhl118jn6ump4b.resolve('fullscreen-maximized'));
      $_759bvl109jn6umoyh.remove(platform.container, $_9ajkhl118jn6ump4b.resolve('android-maximized'));
      $_826n2m16njn6umqdt.restoreStyles();
      $_759bvl109jn6umoyh.remove(platform.body, $_9ajkhl118jn6ump4b.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_2vp5wz15vjn6umq8a = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_9ajkhl118jn6ump4b.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_9ajkhl118jn6ump4b.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_askc7h16pjn6umqec = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_dazinbz2jn6umoq9.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_4rxiy211ljn6ump6j.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_askc7h16pjn6umqec.sketch(onTap, mobile.translate));
    ...
    $_9nc3b5z1jn6umoq7.append(mobile.container, mask.element());
    var mode = $_2vp5wz15vjn6umq8a.create(mobile, maskApi);
    return {
  ...
  var $_1y454315ujn6umq80 = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_9ajkhl118jn6ump4b.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_dva6zk10bjn6umoyj.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_dva6zk10bjn6umoyj.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_48e6gz15rjn6umq7l.bind(scope, 'touchmove', function (event) {
      $_3zl4ya11qjn6ump79.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_cb8fg216xjn6umqgp = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_4rxiy211ljn6ump6j.set(component.element(), 'overflow-x', 'auto');
              $_cb8fg216xjn6umqgp.markAsHorizontal(component.element());
              $_21vyir15ojn6umq6w.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_9ajkhl118jn6ump4b.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_9ajkhl118jn6ump4b.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_9ajkhl118jn6ump4b.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_9ajkhl118jn6ump4b.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_bvg4jv151jn6umq0p.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_759bvl109jn6umoyh.remove(component.element(), slideConfig.openClass());
    $_759bvl109jn6umoyh.add(component.element(), slideConfig.closedClass());
    $_4rxiy211ljn6ump6j.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_4rxiy211ljn6ump6j.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_759bvl109jn6umoyh.remove(component.element(), slideConfig.closedClass());
    $_759bvl109jn6umoyh.add(component.element(), slideConfig.openClass());
    $_4rxiy211ljn6ump6j.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_4rxiy211ljn6ump6j.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_4rxiy211ljn6ump6j.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_4rxiy211ljn6ump6j.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_759bvl109jn6umoyh.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_759bvl109jn6umoyh.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_4rxiy211ljn6ump6j.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_759bvl109jn6umoyh.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_759bvl109jn6umoyh.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_4rxiy211ljn6ump6j.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_cta6ru13fjn6umplv.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_mj8311kjn6ump6h.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_9ajkhl118jn6ump4b.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_9ajkhl118jn6ump4b.resolve('dropup-closed'),
          openClass: $_9ajkhl118jn6ump4b.resolve('dropup-open'),
          shrinkingClass: $_9ajkhl118jn6ump4b.resolve('dropup-shrinking'),
          growingClass: $_9ajkhl118jn6ump4b.resolve('dropup-growing'),
        ...
        $_9eogv9117jn6ump46.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_gct936yzjn6umoq4.name(event$$1.target()));
  };
  var isFirefox = $_g950fwyijn6umons.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_48e6gz15rjn6umq7l.capture(container, 'focus', handler);
    } else {
      return $_48e6gz15rjn6umq7l.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_48e6gz15rjn6umq7l.capture(container, 'blur', handler);
    } else {
      return $_48e6gz15rjn6umq7l.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_g950fwyijn6umons.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_48e6gz15rjn6umq7l.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_48e6gz15rjn6umq7l.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_dazinbz2jn6umoq9.defaultView(container);
    var onWindowScroll = $_48e6gz15rjn6umq7l.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_dazinbz2jn6umoq9.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_et9nvq10ijn6umozg.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_9dg7dyyxjn6umopr.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_dazinbz2jn6umoq9.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_85wxrz8jn6umoqw.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_c6hzqn10gjn6umoz8.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_gct936yzjn6umoq4.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_3m3d03zejn6umork.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_9ajkhl118jn6ump4b.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_9ajkhl118jn6ump4b.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_9ajkhl118jn6ump4b.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_9ajkhl118jn6ump4b.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_365b1g16yjn6umqh0.makeEditSwitch(webapp);
    var socket = $_365b1g16yjn6umqh0.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_1y454315ujn6umq80.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_365b1g16yjn6umqh0.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_4rxiy211ljn6ump6j.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_9nc3b5z1jn6umoq7.append(parent, input);
    $_c6hzqn10gjn6umoz8.focus(input);
    operation(input);
    $_3m3d03zejn6umork.remove(input);
  };
  var $_ztx5x17ijn6umqn8 = { input: input$1 };
  ...
  var $_5nd8pr17kjn6umqnq = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_c6hzqn10gjn6umoz8.active().each(function (active) {
      if (!$_85wxrz8jn6umoqw.eq(active, frame)) {
        $_c6hzqn10gjn6umoz8.blur(active);
      }
    });
    cWin.focus();
    $_c6hzqn10gjn6umoz8.focus(Element$$1.fromDom(cWin.document.body));
    $_5nd8pr17kjn6umqnq.refresh(cWin);
  };
  var $_e34fk17jjn6umqnj = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_e34fk17jjn6umqnj.resume(cWin, frame);
    };
    var toReading = function () {
      $_ztx5x17ijn6umqn8.input(outerBody, $_c6hzqn10gjn6umoz8.blur);
    };
    var captureInput = $_48e6gz15rjn6umq7l.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_gct936yzjn6umoq4.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_mj8311kjn6ump6h.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_48e6gz15rjn6umq7l.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_85wxrz8jn6umoqw.eq(editorApi.html(), touchEvent.target()) || $_85wxrz8jn6umoqw.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_48e6gz15rjn6umq7l.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_48e6gz15rjn6umq7l.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_48e6gz15rjn6umq7l.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_48e6gz15rjn6umq7l.bind(toolstrip, 'touchmove', function () {
  ...
  var $_cn09m317ljn6umqnu = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_759bvl109jn6umoyh.add(container, $_9ajkhl118jn6ump4b.resolve('unfocused-selections'));
    $_9nc3b5z1jn6umoq7.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_48e6gz15rjn6umq7l.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_e34fk17jjn6umqnj.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_bvg4jv151jn6umq0p.add(span, [
        $_9ajkhl118jn6ump4b.resolve('layer-editor'),
        $_9ajkhl118jn6ump4b.resolve('unfocused-selection')
      ]);
      $_4rxiy211ljn6ump6j.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_hj8bs162jn6umqa6.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_a50709zfjn6umoro.append(container, spans);
    };
    var clear = function () {
      $_3m3d03zejn6umork.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_3m3d03zejn6umork.remove(container);
    };
    var isActive = function () {
      return $_dazinbz2jn6umoq9.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_7uc10e17vjn6umqqk = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_7uc10e17vjn6umqqk.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_2ddcyv15qjn6umq7a.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_dazinbz2jn6umoq9.owner(socket).dom().defaultView;
    var viewportHeight = $_mj8311kjn6ump6h.get(socket) + $_mj8311kjn6ump6h.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_mj8311kjn6ump6h.get(socket) + $_mj8311kjn6ump6h.get(dropup) - greenzoneHeight;
    $_4rxiy211ljn6ump6j.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_abh76t17ujn6umqqd = {
  ...
  var yFixedData = 'data-' + $_9ajkhl118jn6ump4b.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_9ajkhl118jn6ump4b.resolve('y-property');
  var yScrollingData = 'data-' + $_9ajkhl118jn6ump4b.resolve('scrolling');
  var windowSizeData = 'data-' + $_9ajkhl118jn6ump4b.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_cegosv161jn6umqa4.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_dva6zk10bjn6umoyj.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_cegosv161jn6umqa4.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_dva6zk10bjn6umoyj.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_1dzk3z11ojn6ump75.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_dva6zk10bjn6umoyj.get(toolbar, 'style');
    $_4rxiy211ljn6ump6j.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_dva6zk10bjn6umoyj.set(toolbar, yFixedData, '0px');
    $_dva6zk10bjn6umoyj.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_dva6zk10bjn6umoyj.set(toolbar, 'style', oldToolbarStyle || '');
      $_dva6zk10bjn6umoyj.remove(toolbar, yFixedData);
      $_dva6zk10bjn6umoyj.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_dva6zk10bjn6umoyj.get(viewport, 'style');
    $_21vyir15ojn6umq6w.register(viewport);
    $_4rxiy211ljn6ump6j.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_dva6zk10bjn6umoyj.set(viewport, yFixedData, toolbarHeight + 'px');
    $_dva6zk10bjn6umoyj.set(viewport, yScrollingData, 'true');
    $_dva6zk10bjn6umoyj.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_21vyir15ojn6umq6w.deregister(viewport);
      $_dva6zk10bjn6umoyj.set(viewport, 'style', oldViewportStyle || '');
      $_dva6zk10bjn6umoyj.remove(viewport, yFixedData);
      $_dva6zk10bjn6umoyj.remove(viewport, yScrollingData);
      $_dva6zk10bjn6umoyj.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_dva6zk10bjn6umoyj.get(dropup, 'style');
    $_4rxiy211ljn6ump6j.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_dva6zk10bjn6umoyj.set(dropup, yFixedData, '0px');
    $_dva6zk10bjn6umoyj.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_dva6zk10bjn6umoyj.set(dropup, 'style', oldDropupStyle || '');
      $_dva6zk10bjn6umoyj.remove(dropup, yFixedData);
      $_dva6zk10bjn6umoyj.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_dazinbz2jn6umoq9.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_dva6zk10bjn6umoyj.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_dazinbz2jn6umoq9.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_mj8311kjn6ump6h.get(toolbar);
    var dropupHeight = $_mj8311kjn6ump6h.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_mj8311kjn6ump6h.get(toolbar);
        var dropupHeight_1 = $_mj8311kjn6ump6h.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_dva6zk10bjn6umoyj.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_4rxiy211ljn6ump6j.set(viewport, 'height', newHeight + 'px');
        $_4rxiy211ljn6ump6j.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_abh76t17ujn6umqqd.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_dva6zk10bjn6umoyj.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_abh76t17ujn6umqqd.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_1ghsru17tjn6umqpv = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_9qicc517sjn6umqpr.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_9ajkhl118jn6ump4b.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_4rxiy211ljn6ump6j.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_4rxiy211ljn6ump6j.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_4rxiy211ljn6ump6j.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_dva6zk10bjn6umoyj.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_cegosv161jn6umqa4.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_dva6zk10bjn6umoyj.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_dva6zk10bjn6umoyj.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_4rxiy211ljn6ump6j.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_1ghsru17tjn6umqpv.getYFixedData(element) + 'px';
    $_4rxiy211ljn6ump6j.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_dazinbz2jn6umoq9.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_abh76t17ujn6umqqd.getGreenzone(socket, dropup);
    var refreshCursor = curry($_5nd8pr17kjn6umqnq.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_8tefum17ojn6umqpb.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_8tefum17ojn6umqpb.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_e3jw8o17xjn6umqqu = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_4rxiy211ljn6ump6j.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_4rxiy211ljn6ump6j.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_8tefum17ojn6umqpb.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_ghe8cr17yjn6umqqx.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_48e6gz15rjn6umq7l.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_ghe8cr17yjn6umqqx.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_1ghsru17tjn6umqpv.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_9dg7dyyxjn6umopr.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_2ddcyv15qjn6umq7a.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_e3jw8o17xjn6umqqu.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_4rxiy211ljn6ump6j.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_8tefum17ojn6umqpb.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_ztx5x17ijn6umqn8.input($_9dg7dyyxjn6umopr.body(), $_c6hzqn10gjn6umoz8.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_eq8p4n17mjn6umqo6 = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_a9ikzi16mjn6umqdf.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_4rxiy211ljn6ump6j.getRaw(platform.socket, 'height'),
          iframeHeight: $_4rxiy211ljn6ump6j.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_cb8fg216xjn6umqgp.exclusive(doc, '.' + $_21vyir15ojn6umq6w.scrollable()) });
        $_759bvl109jn6umoyh.add(platform.container, $_9ajkhl118jn6ump4b.resolve('fullscreen-maximized'));
        $_826n2m16njn6umqdt.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_4rxiy211ljn6ump6j.set(platform.socket, 'overflow', 'scroll');
        $_4rxiy211ljn6ump6j.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_c6hzqn10gjn6umoz8.focus(editorApi.body());
        ...
        iosApi.set($_eq8p4n17mjn6umqo6.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_c8yd1v17hjn6umqmu.stubborn,
        ...
        iosEvents.set($_cn09m317ljn6umqnu.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_4rxiy211ljn6ump6j.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_4rxiy211ljn6ump6j.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_759bvl109jn6umoyh.remove(platform.container, $_9ajkhl118jn6ump4b.resolve('fullscreen-maximized'));
      $_826n2m16njn6umqdt.restoreStyles();
      $_21vyir15ojn6umq6w.deregister(platform.toolbar);
      $_4rxiy211ljn6ump6j.remove(platform.socket, 'overflow');
      $_4rxiy211ljn6ump6j.remove(platform.socket, '-webkit-overflow-scrolling');
      $_c6hzqn10gjn6umoz8.blur(platform.editor.getFrame());
      $_a9ikzi16mjn6umqdf.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_btffdn17gjn6umqmd = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_4rxiy211ljn6ump6j.set(mobile.toolstrip, 'width', '100%');
    $_4rxiy211ljn6ump6j.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_askc7h16pjn6umqec.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_btffdn17gjn6umqmd.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_7nkodp17fjn6umqm4 = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_9ajkhl118jn6ump4b.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_365b1g16yjn6umqh0.makeEditSwitch(webapp);
    var socket = $_365b1g16yjn6umqh0.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_7nkodp17fjn6umqm4.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_frulh181jn6umqrd = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_gbgiqz10ojn6ump03.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_d9t46o184jn6umqrn = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_frulh181jn6umqrd.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_d9t46o184jn6umqrn.fireSkinLoaded(editor));
      } else {
        $_d9t46o184jn6umqrn.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_g950fwyijn6umons.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_9nc3b5z1jn6umoq7.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_c6hzqn10gjn6umoz8.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_2ddcyv15qjn6umq7a.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_gbgiqz10ojn6ump03.orientationChanged()], { width: $_2ddcyv15qjn6umq7a.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_9ajkhl118jn6ump4b.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_gct936yzjn6umoq4.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_gct936yzjn6umoq4.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_2z1q2x10mjn6umozz.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_9ajkhl118jn6ump4b.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_9ajkhl118jn6ump4b.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_gbgiqz10ojn6ump03.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_enpctv119jn6ump4e.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_enpctv119jn6ump4e.forToolbar('readonly-back', function () {
        ...
        var features = $_8stvid10pjn6ump06.setup(realm, editor);
        var items = $_8stvid10pjn6ump06.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_pln5i183jn6umqrg.init(realm, editor);
      });
      return {
