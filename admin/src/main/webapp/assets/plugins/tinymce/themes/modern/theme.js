...
var modern = (function () {
  ...
  var $_iht3vufjn6umntn = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_57nvfrujjn6umntw.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_57nvfrujjn6umntw.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_9xtsikumjn6umnu5.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_57nvfrujjn6umntw.setUiContainer(editor, panel);
  ...
  var $_blwdj6ugjn6umntq = { addContextualToolbars: addContextualToolbars };
  ...
  var $_c64kmgunjn6umnub = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_11qua8uejn6umntl.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_45leiwuqjn6umnup = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_11qua8uejn6umntl.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_asudmiutjn6umnuu = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_bhdf3furjn6umnur.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_asudmiutjn6umnuu.fireSkinLoaded(editor));
    } else {
      $_asudmiutjn6umnuu.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_c64kmgunjn6umnub.createMenuButtons(editor)
            },
            $_9xtsikumjn6umnu5.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_bhdf3furjn6umnur.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_57nvfrujjn6umntw.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_45leiwuqjn6umnup.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_45leiwuqjn6umnup.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_11qua8uejn6umntl.fireBeforeRenderUI(editor);
    ...
    $_iht3vufjn6umntn.addKeys(editor, panel);
    $_blwdj6ugjn6umntq.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_dobyqyuajn6umntg = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_57nvfrujjn6umntw.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_57nvfrujjn6umntw.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_39sckluzjn6umnvn = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_57nvfrujjn6umntw.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_4q8kzlv5jn6umnwc.parseBox(settings.border);
      self$$1.paddingBox = $_4q8kzlv5jn6umnwc.parseBox(settings.padding);
      self$$1.marginBox = $_4q8kzlv5jn6umnwc.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_57nvfrujjn6umntw.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_4q8kzlv5jn6umnwc.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_4q8kzlv5jn6umnwc.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_4q8kzlv5jn6umnwc.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_asudmiutjn6umnuu.fireSkinLoaded(editor));
    } else {
      $_asudmiutjn6umnuu.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_4s6k0fuujn6umnuw = { render: render$1 };
  ...
  var $_3liqr1vhjn6umnxi = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_3liqr1vhjn6umnxi.setup(editor, theme);
    return isInline(editor) ? $_4s6k0fuujn6umnuw.render(editor, theme, args) : $_dobyqyuajn6umntg.render(editor, theme, args);
  };
  var $_fs8lt2u6jn6umnt9 = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_39sckluzjn6umnvn],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_57nvfrujjn6umntw.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_4q8kzlv5jn6umnwc.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_4q8kzlv5jn6umnwc.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_fs8lt2u6jn6umnt9.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_45leiwuqjn6umnup.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_45leiwuqjn6umnup.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_adxggqwkjn6umo1e.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_adxggqwkjn6umo1e.ELEMENT);
  var isText = isType$1($_adxggqwkjn6umo1e.TEXT);
  var isDocument = isType$1($_adxggqwkjn6umo1e.DOCUMENT);
  var $_eotchrwjjn6umo1d = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_eotchrwjjn6umo1d.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_e4cjm1wrjn6umo2b = { toArray: toArray };
  ...
  var $_4c6a95wujn6umo2o = { getOrDie: getOrDie };

  var node = function () {
    var f = $_4c6a95wujn6umo2o.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_a42wcix0jn6umo34.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_a42wcix0jn6umo34.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_a42wcix0jn6umo34.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_gaq7fox4jn6umo3f = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_gaq7fox4jn6umo3f.browsers();
    var oses = $_gaq7fox4jn6umo3f.oses();
    var browser = $_1p4lnjx3jn6umo3b.detectBrowser(browsers, userAgent).fold($_66zxehwzjn6umo30.unknown, $_66zxehwzjn6umo30.nu);
    var os = $_1p4lnjx3jn6umo3b.detectOs(oses, userAgent).fold($_2ek4ghx1jn6umo35.unknown, $_2ek4ghx1jn6umo35.nu);
  ...
  var $_rfv4lwyjn6umo2z = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_rfv4lwyjn6umo2z.detect(userAgent);
  });
  var $_30orj6wxjn6umo2t = { detect: detect$3 };

  var ELEMENT = $_adxggqwkjn6umo1e.ELEMENT;
  var DOCUMENT = $_adxggqwkjn6umo1e.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_334ar5wtjn6umo2n.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_30orj6wxjn6umo2t.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_8v0pdrwsjn6umo2c = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_dd2bdbx8jn6umo3p.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_8v0pdrwsjn6umo2c.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_8v0pdrwsjn6umo2c.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_e4cjm1wrjn6umo2b.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_e4cjm1wrjn6umo2b.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_3q21mfwhjn6umo18.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_9yovsewljn6umo1h.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_9yovsewljn6umo1h.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_9yovsewljn6umo1h.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_9yovsewljn6umo1h.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_dd2bdbx8jn6umo3p.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_a03zl3wgjn6umo15.ancestors(scope, function (e) {
      return $_dd2bdbx8jn6umo3p.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_a03zl3wgjn6umo15.siblings(scope, function (e) {
      return $_dd2bdbx8jn6umo3p.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_a03zl3wgjn6umo15.children(scope, function (e) {
      return $_dd2bdbx8jn6umo3p.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_dd2bdbx8jn6umo3p.all(selector, scope);
  };
  var $_923da0wfjn6umo14 = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_923da0wfjn6umo14.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_2z0rkdwcjn6umo0h = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_2z0rkdwcjn6umo0h.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_3q21mfwhjn6umo18.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_8v0pdrwsjn6umo2c.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_dd2bdbx8jn6umo3p.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_7vx59oxejn6umo4f.ancestor(scope, function (e) {
      return $_dd2bdbx8jn6umo3p.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_7vx59oxejn6umo4f.sibling(scope, function (e) {
      return $_dd2bdbx8jn6umo3p.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_7vx59oxejn6umo4f.child(scope, function (e) {
      return $_dd2bdbx8jn6umo3p.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_dd2bdbx8jn6umo3p.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_dd2bdbx8jn6umo3p.is, ancestor$1, scope, selector, isRoot);
  };
  var $_c2xvyrxdjn6umo4e = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_dq7t3axgjn6umo4w = { register: register };
  ...
  var $_am88ouxijn6umo50 = { register: register$1 };
  ...
  var $_cioqmjxjjn6umo52 = { register: register$2 };
  ...
  var $_o1u76xkjn6umo55 = { register: register$3 };
  ...
  var $_1ku8texljn6umo59 = { register: register$4 };
  ...
  var $_2w0y9lxmjn6umo5c = { register: register$5 };
  ...
  var $_8jsx5uxnjn6umo5g = { register: register$6 };
  ...
  var $_8eunxexojn6umo5i = { register: register$7 };
  ...
  var $_6fp4zoxpjn6umo5n = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_c2xvyrxdjn6umo4e.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_1ku8texljn6umo59.register(editor);
    $_dq7t3axgjn6umo4w.register(editor);
    $_8jsx5uxnjn6umo5g.register(editor);
    $_8eunxexojn6umo5i.register(editor);
    $_cioqmjxjjn6umo52.register(editor);
    $_am88ouxijn6umo50.register(editor);
    $_o1u76xkjn6umo55.register(editor);
    $_6fp4zoxpjn6umo5n.register(editor);
    $_2w0y9lxmjn6umo5c.register(editor);
  };
  var $_3w2y5zxcjn6umo48 = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_dpk5kvvcjn6umnwz,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_7fx31fvejn6umnx9,
      Panel: Panel,
      Movable: $_39sckluzjn6umnvn,
      Resizable: $_3mekovvgjn6umnxg,
      ...
      FormatControls: $_3w2y5zxcjn6umo48,
  ...
  global.add('modern', function (editor) {
    $_3w2y5zxcjn6umo48.setup(editor);
    return $_bapk2su5jn6umnt7.get(editor);
  });
  function Theme () {
  }
