...
var inlite = (function () {
  ...
  var $_82hhxw18cjn6umrrw = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_35ic3g18gjn6umrs0.fromClientRect(clientRect)) : null;
  };
  var $_58h9yx18fjn6umrrz = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_ektjky18ejn6umrry.result(predicateIds[i].id, $_58h9yx18fjn6umrrz.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_ektjky18ejn6umrry.result(predicateIds[x].id, $_58h9yx18fjn6umrrz.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_ektjky18ejn6umrry.result(id, $_58h9yx18fjn6umrrz.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_ektjky18ejn6umrry.result(id, $_58h9yx18fjn6umrrz.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_bqrqp18pjn6umrs9.isArray(value)) {
      return value;
    } else if ($_bqrqp18pjn6umrs9.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_bqrqp18pjn6umrs9.isBoolean(value)) {
  ...
  var $_c90ki918ojn6umrs8 = {
    getStringOr: getByTypeOr($_bqrqp18pjn6umrs9.isString),
    getBoolOr: getByTypeOr($_bqrqp18pjn6umrs9.isBoolean),
    getNumberOr: getByTypeOr($_bqrqp18pjn6umrs9.isNumber),
    getHandlerOr: getByTypeOr($_bqrqp18pjn6umrs9.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_bqrqp18pjn6umrs9.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_35ic3g18gjn6umrs0.toClientRect(targetRect),
        contentAreaRect: $_35ic3g18gjn6umrs0.toClientRect(contentAreaRect),
        panelRect: $_35ic3g18gjn6umrs0.toClientRect(panelRect)
      });
      return $_35ic3g18gjn6umrs0.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_c90ki918ojn6umrs8.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_c90ki918ojn6umrs8.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_c90ki918ojn6umrs8.getHandlerOr(editor, 'inline_toolbar_position_handler', $_9qywg218qjn6umrsb.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_1bd23l18ljn6umrs5.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_c48pid18mjn6umrs6.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_c48pid18mjn6umrs6.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_e015pj18kjn6umrs4 = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_82hhxw18cjn6umrrw.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_9yekzt18hjn6umrs1.fromContextToolbars(toolbars);
    result = $_ektjky18ejn6umrry.match(editor, [
      $_cg0pxl18djn6umrrx.element(elements[0], contextToolbarsPredicateIds),
      $_cedrcq18jjn6umrs3.textSelection('text'),
      $_cedrcq18jjn6umrs3.emptyTextBlock(elements, 'insert'),
      $_cg0pxl18djn6umrrx.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_ektjky18ejn6umrry.match(editor, [$_cedrcq18jjn6umrs3.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_e015pj18kjn6umrs4.load(editor, function () {
  ...
  var $_73ed9j188jn6umrrs = { renderUI: renderUI };
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_398gxg194jn6umru3.parseBox(settings.border);
      self$$1.paddingBox = $_398gxg194jn6umru3.parseBox(settings.padding);
      self$$1.marginBox = $_398gxg194jn6umru3.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_ay5pkh19cjn6umruj.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_398gxg194jn6umru3.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_398gxg194jn6umru3.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_398gxg194jn6umru3.measureBox(elm, 'margin');
    ...
    fire: function (name$$1, args, bubble) {
      ...
      if (bubble !== false && self$$1.parent) {
        var parent_1 = self$$1.parent();
        while (parent_1 && !args.isPropagationStopped()) {
          parent_1.fire(name$$1, args, false);
    ...
    reflow: function () {
      $_g3oi7419bjn6umrui.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_ay5pkh19cjn6umruj.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_ay5pkh19cjn6umruj.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_2h127t19djn6umrun = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_ay5pkh19cjn6umruj.getUiContainer(self$$1);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_ay5pkh19cjn6umruj.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_398gxg194jn6umru3.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_398gxg194jn6umru3.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_73ed9j188jn6umrrs.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_gegifx187jn6umrrq = { get: get };
  ...
  var $_6a7i2v19vjn6umrw8 = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_6a7i2v19vjn6umrw8.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_ftwus419tjn6umrw4 = { blobToBase64: blobToBase64 };
  ...
  var $_7gcetf19zjn6umrwi = { pickFile: pickFile };
  ...
  var $_atiae11a1jn6umrwn = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_89w0hg1a3jn6umrwq.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_89w0hg1a3jn6umrwq.resolve(dom, bookmark));
  };
  ...
  var $_bih85e1a2jn6umrwo = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_atiae11a1jn6umrwn.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_bih85e1a2jn6umrwo.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_4wu15w1a0jn6umrwl.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_7gcetf19zjn6umrwi.pickFile().then(function (files) {
          var blob = files[0];
          $_ftwus419tjn6umrw4.blobToBase64(blob).then(function (base64) {
            $_4wu15w1a0jn6umrwl.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_4wu15w1a0jn6umrwl.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_73aneu19sjn6umrw1 = { addToEditor: addToEditor };
  ...
  var $_g080nx1a7jn6umrww = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_a2rgbm1a9jn6umrx2.isAbsolute(href) && $_a2rgbm1a9jn6umrx2.isDomainLike(href) ? askAboutPrefix(editor, href) : global$12.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_4wu15w1a0jn6umrwl.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_4wu15w1a0jn6umrwl.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_9h0uyk1a8jn6umrwz = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_bqrqp18pjn6umrs9.isArray(items)) {
      return items;
    } else if ($_bqrqp18pjn6umrs9.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_bqrqp18pjn6umrs9.isFunction(button)) {
            button = button();
          }
  ...
  var $_2xtn261aajn6umrx3 = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_2xtn261aajn6umrx3.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_2xtn261aajn6umrx3.create(editor, 'text', $_c48pid18mjn6umrs6.getTextSelectionToolbarItems(editor)),
        $_2xtn261aajn6umrx3.create(editor, 'insert', $_c48pid18mjn6umrs6.getInsertToolbarItems(editor)),
        $_9h0uyk1a8jn6umrwz.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_c48pid18mjn6umrs6.getPositionHandler(editor);
      contentAreaRect = $_58h9yx18fjn6umrrz.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_9qywg218qjn6umrsb.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_9qywg218qjn6umrsb.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_g080nx1a7jn6umrww.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_9qywg218qjn6umrsb.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_58h9yx18fjn6umrrz.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_9qywg218qjn6umrsb.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_9qywg218qjn6umrsb.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_1bd23l18ljn6umrs5.fireBeforeRenderUI(editor);
  ...
  var isComment = function (element) {
    return type(element) === $_6u9pxw1b4jn6umrzz.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_6u9pxw1b4jn6umrzz.ELEMENT);
  var isText = isType$2($_6u9pxw1b4jn6umrzz.TEXT);
  var isDocument = isType$2($_6u9pxw1b4jn6umrzz.DOCUMENT);
  var $_3121tw1b3jn6umrzy = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_3121tw1b3jn6umrzy.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_aokymi1bbjn6ums0o = { toArray: toArray };

  var node = function () {
    var f = $_6a7i2v19vjn6umrw8.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_l97me1bhjn6ums1a.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_l97me1bhjn6ums1a.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_l97me1bhjn6ums1a.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_e6e0kf1bljn6ums1p = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_e6e0kf1bljn6ums1p.browsers();
    var oses = $_e6e0kf1bljn6ums1p.oses();
    var browser = $_dsb0h41bkjn6ums1l.detectBrowser(browsers, userAgent).fold($_de4ci91bgjn6ums16.unknown, $_de4ci91bgjn6ums16.nu);
    var os = $_dsb0h41bkjn6ums1l.detectOs(oses, userAgent).fold($_48hln61bijn6ums1b.unknown, $_48hln61bijn6ums1b.nu);
  ...
  var $_9x4miz1bfjn6ums15 = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_9x4miz1bfjn6ums15.detect(userAgent);
  });
  var $_amznm61bejn6ums10 = { detect: detect$3 };

  var ELEMENT = $_6u9pxw1b4jn6umrzz.ELEMENT;
  var DOCUMENT = $_6u9pxw1b4jn6umrzz.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_13a43b1bdjn6ums0z.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_amznm61bejn6ums10.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_g1z0231bcjn6ums0p = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_cjch6u1bpjn6ums20.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_g1z0231bcjn6ums0p.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_g1z0231bcjn6ums0p.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_aokymi1bbjn6ums0o.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_aokymi1bbjn6ums0o.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_eix4j41b1jn6umrzt.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_1mg03y1b5jn6ums01.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_1mg03y1b5jn6ums01.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_1mg03y1b5jn6ums01.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_1mg03y1b5jn6ums01.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_cjch6u1bpjn6ums20.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_azrdse1b0jn6umrzl.ancestors(scope, function (e) {
      return $_cjch6u1bpjn6ums20.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_azrdse1b0jn6umrzl.siblings(scope, function (e) {
      return $_cjch6u1bpjn6ums20.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_azrdse1b0jn6umrzl.children(scope, function (e) {
      return $_cjch6u1bpjn6ums20.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_cjch6u1bpjn6ums20.all(selector, scope);
  };
  var $_clz5ld1azjn6umrzk = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_clz5ld1azjn6umrzk.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_cq2chc1awjn6umryy = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_cq2chc1awjn6umryy.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_eix4j41b1jn6umrzt.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_g1z0231bcjn6ums0p.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_cjch6u1bpjn6ums20.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_6e6zdl1bvjn6ums2l.ancestor(scope, function (e) {
      return $_cjch6u1bpjn6ums20.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_6e6zdl1bvjn6ums2l.sibling(scope, function (e) {
      return $_cjch6u1bpjn6ums20.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_6e6zdl1bvjn6ums2l.child(scope, function (e) {
      return $_cjch6u1bpjn6ums20.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_cjch6u1bpjn6ums20.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_cjch6u1bpjn6ums20.is, ancestor$1, scope, selector, isRoot);
  };
  var $_2ww2ph1bujn6ums2j = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_a5cv5b1bxjn6ums38 = { register: register };
  ...
  var $_be40pa1bzjn6ums3b = { register: register$1 };
  ...
  var $_17iqhp1c0jn6ums3d = { register: register$2 };
  ...
  var $_fx6rg61c1jn6ums3i = { register: register$3 };
  ...
  var $_bskmby1c2jn6ums3m = { register: register$4 };
  ...
  var $_6jukv11c3jn6ums3o = { register: register$5 };
  ...
  var $_fw1xzz1c4jn6ums3r = { register: register$6 };
  ...
  var $_2gvp8u1c5jn6ums3t = { register: register$7 };
  ...
  var $_ex8uwj1c6jn6ums3u = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_2ww2ph1bujn6ums2j.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_bskmby1c2jn6ums3m.register(editor);
    $_a5cv5b1bxjn6ums38.register(editor);
    $_fw1xzz1c4jn6ums3r.register(editor);
    $_2gvp8u1c5jn6ums3t.register(editor);
    $_17iqhp1c0jn6ums3d.register(editor);
    $_be40pa1bzjn6ums3b.register(editor);
    $_fx6rg61c1jn6ums3i.register(editor);
    $_ex8uwj1c6jn6ums3u.register(editor);
    $_6jukv11c3jn6ums3o.register(editor);
  };
  var $_evqqc31btjn6ums2e = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_g3oi7419bjn6umrui,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_9wti9y19pjn6umrvu,
      Panel: Panel,
      Movable: $_2h127t19djn6umrun,
      Resizable: $_aqeoyh19qjn6umrvw,
      ...
      FormatControls: $_evqqc31btjn6ums2e,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_evqqc31btjn6ums2e.setup(editor);
    $_73aneu19sjn6umrw1.addToEditor(editor, panel);
    return $_gegifx187jn6umrrq.get(editor, panel);
  });
  function Theme () {
  }
