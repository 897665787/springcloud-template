...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_ddlzjajijn6uml93.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_ddlzjajijn6uml93.getPreviewDialogWidth(editor);
    var dialogHeight = $_ddlzjajijn6uml93.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_d0xwrkjjjn6uml95.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_af2li5jgjn6uml91 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_af2li5jgjn6uml91.open(editor);
    });
  };
  var $_dkx8yjjfjn6uml90 = { register: register };
  ...
  var $_2919ytjljn6uml97 = { register: register$1 };

  global.add('preview', function (editor) {
    $_dkx8yjjfjn6uml90.register(editor);
    $_2919ytjljn6uml97.register(editor);
  });
  function Plugin () {
  }
