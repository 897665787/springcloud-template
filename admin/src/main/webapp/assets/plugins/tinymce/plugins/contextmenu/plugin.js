...
var contextmenu = (function () {
  ...
  var $_cokp3gaujn6umk3q = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_6a0fwtatjn6umk3o.getContextMenu(editor);
  ...
  var $_2izjvaxjn6umk3u = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_6a0fwtatjn6umk3o.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_2izjvaxjn6umk3u.show(editor, $_cokp3gaujn6umk3q.getPos(editor, e), visibleState, menu);
    });
  };
  var $_8gtpazasjn6umk3n = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_8gtpazasjn6umk3n.setup(editor, visibleState, menu);
    return $_6xtsplarjn6umk3m.get(visibleState);
  });
  function Plugin () {
  }
