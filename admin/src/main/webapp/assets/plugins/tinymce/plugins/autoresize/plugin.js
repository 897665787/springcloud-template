...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_e173qy92jn6umjuu.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_e173qy92jn6umjuu.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_e173qy92jn6umjuu.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_e173qy92jn6umjuu.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_e173qy92jn6umjuu.getAutoResizeBottomMargin(editor);
    ...
    if ($_e173qy92jn6umjuu.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_eix7pq8zjn6umjur.resize(editor, oldSize);
    });
  };
  var $_dde2z38yjn6umjup = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_dde2z38yjn6umjup.register(editor, oldSize);
      $_eix7pq8zjn6umjur.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
