...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_6rwwgbfbjn6umkr0.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_6rwwgbfbjn6umkr0.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_6rwwgbfbjn6umkr0.getSelectorConverter(editor)) {
      selectorConverter = $_6rwwgbfbjn6umkr0.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_6rwwgbfbjn6umkr0.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_6rwwgbfbjn6umkr0.getCssGroups(editor));
      ...
      if (!$_6rwwgbfbjn6umkr0.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_6rwwgbfbjn6umkr0.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_9gglyhf6jn6umkqu.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_4pl2nzf5jn6umkqs = { get: get };

  global.add('importcss', function (editor) {
    $_9gglyhf6jn6umkqu.setup(editor);
    return $_4pl2nzf5jn6umkqs.get(editor);
  });
  function Plugin () {
  }
