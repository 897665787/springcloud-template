...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_fur39iafjn6umk1a.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_4wrglqaajn6umjzq.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_7f08xbacjn6umjzt.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_9f0dqoagjn6umk1c = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_9666u5a9jn6umjzp = {
    open: function (editor) {
      var minWidth = $_4wrglqaajn6umjzq.getDialogMinWidth(editor);
      var minHeight = $_4wrglqaajn6umjzq.getDialogMinHeight(editor);
      var currentLanguage = $_9f0dqoagjn6umk1c.getCurrentLanguage(editor);
      var currentLanguages = $_9f0dqoagjn6umk1c.getLanguages(editor);
      var currentCode = $_7f08xbacjn6umjzt.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_7f08xbacjn6umjzt.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_fur39iafjn6umk1a.isCodeSample(node)) {
        $_9666u5a9jn6umjzp.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_c5s1txa8jn6umjzn = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_fur39iafjn6umk1a.trimArg($_fur39iafjn6umk1a.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_fur39iafjn6umk1a.trimArg($_fur39iafjn6umk1a.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_89t7wrahjn6umk1e = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_4wrglqaajn6umjzq.getContentCss(editor);
  ...
  var $_ewnd9daijn6umk1h = { loadCss: loadCss };
  ...
  var $_ac3hskajjn6umk1i = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_89t7wrahjn6umk1e.setup(editor);
    $_ac3hskajjn6umk1i.register(editor);
    $_c5s1txa8jn6umjzn.register(editor);
    editor.on('init', function () {
      $_ewnd9daijn6umk1h.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_fur39iafjn6umk1a.isCodeSample(ev.target)) {
        $_9666u5a9jn6umjzp.open(editor);
      }
    });
  });
