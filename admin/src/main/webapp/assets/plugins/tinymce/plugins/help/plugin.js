...
var help = (function () {
  ...
  var $_4lli96bljn6umk5x = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = map($_4lli96bljn6umk5x.shortcuts, function (shortcut) {
  ...
  var $_d28eajbfjn6umk57 = { makeTab: makeTab };
  ...
  var $_39vexgbnjn6umk62 = { makeTab: makeTab$1 };
  ...
  var $_ejvii3btjn6umk6n = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_d28eajbfjn6umk57.makeTab(),
          $_39vexgbnjn6umk62.makeTab(editor)
        ],
        buttons: $_ejvii3btjn6umk6n.makeRow(),
  ...
  var $_9io3gebejn6umk55 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_9io3gebejn6umk55.open(editor, pluginUrl));
  };
  var $_9wlh0gbdjn6umk54 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_9io3gebejn6umk55.open(editor, pluginUrl)
    });
  ...
  var $_7qi0c7bvjn6umk6p = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_7qi0c7bvjn6umk6p.register(editor, pluginUrl);
    $_9wlh0gbdjn6umk54.register(editor, pluginUrl);
