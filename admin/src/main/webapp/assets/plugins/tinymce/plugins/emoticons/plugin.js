...
var emoticons = (function () {
  ...
  var $_c03uh2b9jn6umk4p = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_c03uh2b9jn6umk4p.getHtml(pluginUrl);
  ...
  var $_6lcbd3b8jn6umk4n = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_6lcbd3b8jn6umk4n.register(editor, pluginUrl);
  });
  function Plugin () {
  }
