...
var wordcount = (function () {
  ...
  var $_5788phtojn6umnrd = {
    each: each,
    map: map
  };

  var SETS$1 = $_5pzb4xtmjn6umnr8.SETS;
  var OTHER = $_5pzb4xtmjn6umnr8.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_5788phtojn6umnrd.map(string.split(''), memoized);
  };
  var $_3q1j63tnjn6umnrb = { classify: classify };

  var ci = $_5pzb4xtmjn6umnr8.characterIndices;
  ...
  var $_8aqo03tpjn6umnrf = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_5pzb4xtmjn6umnr8.EMPTY_STRING;
  var WHITESPACE$1 = $_5pzb4xtmjn6umnr8.WHITESPACE;
  var PUNCTUATION$1 = $_5pzb4xtmjn6umnr8.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_3q1j63tnjn6umnrb.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_8aqo03tpjn6umnrf.isWordBoundary(map, i)) {
  ...
  var $_bcyi49tljn6umnr4 = { getWords: getWords };
  ...
  var getCount = function (editor) {
    return $_bcyi49tljn6umnr4.getWords(getTextContent(editor)).length;
  };
  var $_5oq7octijn6umnr2 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_5oq7octijn6umnr2.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_dci0uvthjn6umnr0 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$4.translate([
        '{0} words',
        $_5oq7octijn6umnr2.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_ckdd5wtqjn6umnrh = { setup: setup };

  global.add('wordcount', function (editor) {
    $_ckdd5wtqjn6umnrh.setup(editor);
    return $_dci0uvthjn6umnr0.get(editor);
  });
  function Plugin () {
  }
