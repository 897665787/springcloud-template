...
(function ($) {
    ...
    Dropdown.prototype = {
        init: function () {
            ...
            //回显
            if($el.find("select").data("init") !== void 0){
                _this.choose(String($el.find("select").data("init")).split(","));
            }
        },
        ...
        renderSelect: function (isUpdate, isCover) {
            ...
            if (isUpdate) {
                ...
                $el.append(template).find('ul').removeAttr('style class').addClass("xs-scrollbar");
            }
