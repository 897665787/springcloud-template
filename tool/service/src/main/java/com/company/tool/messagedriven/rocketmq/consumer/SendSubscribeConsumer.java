...
@RocketMQMessageListener(
		...
		consumerGroup = Constants.QUEUE.SEND_SUBSCRIBE.NAME,
		selectorType = SelectorType.TAG,
		selectorExpression = Constants.QUEUE.SEND_SUBSCRIBE.KEY
)
@Slf4j
@Conditional(RocketMQAutoConfiguration.RocketMQCondition.class)
public class SendSubscribeConsumer implements RocketMQListener<MessageExt> {
	@Override
