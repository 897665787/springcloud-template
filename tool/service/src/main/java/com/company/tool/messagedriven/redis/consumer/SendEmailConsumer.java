...
public class SendEmailConsumer {
    ...
    @Bean
    public MessageListener sendEmailMessageListener() {
        return new MessageListener() {
            ...
            public void onMessage(Message message, byte[] pattern) {
                ...
                String strategyName = StrategyConstants.SENDEMAIL_STRATEGY;
    ...
    @Bean
    public Object registerSendEmailConsumer(RedisMessageListenerContainer container, MessageListener sendEmailMessageListener, MessagedrivenProperties messagedrivenProperties) {
        String channel = String.format("%s:%s", messagedrivenProperties.getExchange().getDirect(), Constants.QUEUE.SEND_EMAIL.KEY);
