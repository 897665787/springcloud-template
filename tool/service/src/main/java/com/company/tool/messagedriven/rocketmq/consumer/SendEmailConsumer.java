...
@RocketMQMessageListener(
		...
		consumerGroup = Constants.QUEUE.SEND_EMAIL.NAME,
		selectorType = SelectorType.TAG,
		selectorExpression = Constants.QUEUE.SEND_EMAIL.KEY
)
@Slf4j
@Conditional(RocketMQAutoConfiguration.RocketMQCondition.class)
public class SendEmailConsumer implements RocketMQListener<MessageExt> {
	@Override
