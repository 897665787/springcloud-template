...
public class OrderCreateConsumer {
	...
	@RabbitListener(
			bindings = @QueueBinding(value = @Queue(value = BroadcastConstants.ORDER_CREATE.SMS_QUEUE, durable = "false", autoDelete = "true"),
			exchange = @Exchange(value = BroadcastConstants.ORDER_CREATE.EXCHANGE, type = ExchangeTypes.FANOUT, durable = "false", autoDelete = "true")))
	...
	@RabbitListener(
			bindings = @QueueBinding(value = @Queue(value = BroadcastConstants.ORDER_CREATE.COUNTMONEY_QUEUE, durable = "false", autoDelete = "true"),
					exchange = @Exchange(value = BroadcastConstants.ORDER_CREATE.EXCHANGE, type = ExchangeTypes.FANOUT, durable = "false", autoDelete = "true")))
