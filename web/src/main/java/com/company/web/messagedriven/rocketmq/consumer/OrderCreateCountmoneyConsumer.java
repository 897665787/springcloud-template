...
@RocketMQMessageListener(
        topic = BroadcastConstants.ORDER_CREATE.EXCHANGE,
        consumerGroup = BroadcastConstants.ORDER_CREATE.COUNTMONEY_QUEUE
)
@Slf4j
...
public class OrderCreateCountmoneyConsumer implements RocketMQListener<MessageExt> {
    ...
    public void onMessage(MessageExt messageExt) {
        ...
        properties.put(HeaderConstants.HEADER_STRATEGY_NAME, StrategyConstants.ORDERCREATE_COUNTMONEY_STRATEGY);
