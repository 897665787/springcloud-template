...
CREATE TABLE `bu_order` (
  ...
  `business_type` varchar(16) NOT NULL DEFAULT '' COMMENT '业务类型(naixue:奈雪的茶,xicha:喜茶)',
  `business_id` varchar(32) NOT NULL DEFAULT '' COMMENT '业务ID(记录关键信息ID，用于后续查询数据)',
  `business_name` varchar(32) NOT NULL DEFAULT '' COMMENT '业务名称',
...
CREATE TABLE `bu_order_product` (
  ...
  `spec_json` varchar(2048) NOT NULL DEFAULT '' COMMENT '规格JSON',
  `spec_content` varchar(1024) NOT NULL DEFAULT '' COMMENT '规格内容',
  `product_remark` varchar(255) DEFAULT '' COMMENT '商品备注',
  `business_type` varchar(16) NOT NULL DEFAULT '' COMMENT '业务类型(naixue:奈雪的茶,xicha:喜茶)',
  `business_id` varchar(32) NOT NULL DEFAULT '' COMMENT '业务ID(记录关键信息ID，用于后续查询数据)',
  `business_name` varchar(32) NOT NULL DEFAULT '' COMMENT '业务名称',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注(多个使用/分隔)',
