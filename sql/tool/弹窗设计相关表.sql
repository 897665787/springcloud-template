...
DROP TABLE IF EXISTS `mk_popup_pop_condition`;
...
-- 测试数据
INSERT INTO `mk_popup`(`id`, `begin_time`, `end_time`, `status`, `priority`, `title`, `text`, `bg_img`, `close_btn`, `remark`, `create_time`, `update_time`) VALUES (1, '2023-09-04 10:29:39', '2023-09-05 10:29:37', 'on', 10, '新人有礼', '欢迎注册！！！', '{\"imgUrl\":\"https://images.lssqpay.com/aaa/bbb.jpg\",\"type\":\"redirct\",\"value\":\"/page/aaa/bbb?userId={userId}\"}', '{\"type\":\"close\",\"text\":\"X\",\"value\":\"\"}', '', '2023-09-04 10:29:39', '2023-09-04 14:10:57');
INSERT INTO `mk_popup`(`id`, `begin_time`, `end_time`, `status`, `priority`, `title`, `text`, `bg_img`, `close_btn`, `remark`, `create_time`, `update_time`) VALUES (3, '2023-09-04 14:03:13', '2023-09-05 14:03:10', 'on', 3, '优惠券发放', '恭喜你获得1张5元优惠券', '{\"imgUrl\":\"https://images.lssqpay.com/aaa/bbb.jpg\",\"type\":\"redirct\",\"value\":\"/page/aaa/bbb?userId={userId}\"}', '{\"type\":\"close\",\"text\":\"X\",\"value\":\"\"}', '', '2023-09-04 14:03:13', '2023-09-04 14:04:26');
INSERT INTO `mk_popup`(`id`, `begin_time`, `end_time`, `status`, `priority`, `title`, `text`, `bg_img`, `close_btn`, `remark`, `create_time`, `update_time`) VALUES (10, '2023-11-17 16:12:23', '2023-11-25 16:12:23', 'on', 449, '新人有礼', '欢迎注册！！！', '{\"imgUrl\":\"https://images.lssqpay.com/aaa/bbb.jpg\",\"type\":\"redirct\",\"value\":\"/page/aaa/bbb?userId={userId}\"}', '{\"type\":\"close\",\"text\":\"X\",\"value\":\"\"}', '', '2023-09-04 16:13:27', '2023-09-04 16:13:27');
INSERT INTO `mk_popup`(`id`, `begin_time`, `end_time`, `status`, `priority`, `title`, `text`, `bg_img`, `close_btn`, `remark`, `create_time`, `update_time`) VALUES (11, '2023-12-05 16:12:23', '2024-01-02 16:12:23', 'on', 828, '新人有礼', '欢迎注册！！！', '{\"imgUrl\":\"https://images.lssqpay.com/aaa/bbb.jpg\",\"type\":\"redirct\",\"value\":\"/page/aaa/bbb?userId={userId}\"}', '{\"type\":\"close\",\"text\":\"X\",\"value\":\"\"}', '', '2023-09-04 16:13:27', '2023-09-04 16:13:27');



DROP TABLE IF EXISTS `mk_popup_condition`;
...
-- 测试数据
INSERT INTO `template`.`mk_popup_condition`(`id`, `popup_id`, `pop_condition`, `pop_condition_value`, `remark`, `create_time`, `update_time`) VALUES (1, 1, 'PushAreaCondition', '{\"areaCodes\":\"0\"}', '', '2023-09-04 11:41:12', '2023-09-04 11:41:42');
INSERT INTO `template`.`mk_popup_condition`(`id`, `popup_id`, `pop_condition`, `pop_condition_value`, `remark`, `create_time`, `update_time`) VALUES (2, 3, 'PushAreaCondition', '{\"areaCodes\":\"0\"}', '', '2023-09-04 11:41:12', '2023-09-04 11:41:42');
INSERT INTO `template`.`mk_popup_condition`(`id`, `popup_id`, `pop_condition`, `pop_condition_value`, `remark`, `create_time`, `update_time`) VALUES (12205, 10, 'PushAreaCondition', '{\"areaCodes\":\"0\"}', '', '2023-09-04 16:13:27', '2023-09-04 16:13:27');
INSERT INTO `template`.`mk_popup_condition`(`id`, `popup_id`, `pop_condition`, `pop_condition_value`, `remark`, `create_time`, `update_time`) VALUES (12206, 11, 'PushAreaCondition', '{\"areaCodes\":\"0\"}', '', '2023-09-04 16:13:27', '2023-09-04 16:13:27');
...
DROP TABLE IF EXISTS `mk_popup_log`;
