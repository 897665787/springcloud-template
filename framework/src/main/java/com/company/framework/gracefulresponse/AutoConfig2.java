...
import com.feiniaojin.gracefulresponse.Init;
...
public class AutoConfig2 {
    ...
    @Bean
    public FeignGlobalExceptionAdvice defaultGlobalExceptionAdvice(BeforeControllerAdviceProcess beforeControllerAdviceProcess,
                                                                     @Lazy RejectStrategy rejectStrategy) {
        FeignGlobalExceptionAdvice advice = new FeignGlobalExceptionAdvice();
