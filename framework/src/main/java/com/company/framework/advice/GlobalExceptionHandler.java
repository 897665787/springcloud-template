...
//	public ? error(Exception e, HttpServletRequest request, HttpServletResponse response,
//			HandlerMethod handler) {
//		log.error("未知异常:", e);
//		sendErrorIfPage(request, response, handler);
//		throw new BusinessException(ResultCode.SYSTEM_ERROR).setTraceId(traceManager.get());
//	}
//
//	/**
//	 * 请求方式不支持
...
//	public ? handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e,
...
//	public ? httpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException e,
//			HttpServletRequest request, HttpServletResponse response) {
...
//	public ? missingServletRequestParameter(MissingServletRequestParameterException e,
//			HttpServletRequest request, HttpServletResponse response) {
...
//	public ? methodArgumentTypeMismatch(MethodArgumentTypeMismatchException e, HttpServletRequest request,
...
//	public ? maxUploadSizeExceededException(MaxUploadSizeExceededException e,
//			HttpServletRequest request, HttpServletResponse response) {
...
//	public ? runtime(RuntimeException e, HttpServletRequest request, HttpServletResponse response,
//			HandlerMethod handler) {
...
//	public ? unauthorized(UnauthorizedException e, HttpServletRequest request, HttpServletResponse response,
//								  HandlerMethod handler) {
...
//	public ? business(BusinessException e, HttpServletRequest request, HttpServletResponse response,
//			HandlerMethod handler) {
...
//	public ? resolveConstraintViolationException(ConstraintViolationException e, HttpServletRequest request,
...
//			throw new BusinessException(messageStr);
//		}
...
//	public ? resolveMethodArgumentNotValidException(MethodArgumentNotValidException e,
...
//	public ? handleBingException(BindException e, HttpServletRequest request, HttpServletResponse response,
//			HandlerMethod handler) {
//		sendErrorIfPage(request, response, handler);
...
//	public ? duplicateKey(DuplicateKeyException e, HttpServletRequest request, HttpServletResponse response,
//			HandlerMethod handler) {
//		log.error("数据重复异常", e);
//		sendErrorIfPage(request, response, handler);
