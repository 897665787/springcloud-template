...
public class TraceThreadPoolTaskExecutor extends ThreadPoolTaskExecutor {
	...
	public TraceThreadPoolTaskExecutor(TraceManager traceManager) {
	...
	protected ExecutorService initializeExecutor(ThreadFactory threadFactory,
		...
		if (this.taskDecorator != null) {
			executor = new TraceThreadPoolExecutor(this.corePoolSize, this.maxPoolSize, this.keepAliveSeconds,
					TimeUnit.SECONDS, queue, threadFactory, rejectedExecutionHandler, traceManager) {
				@Override
