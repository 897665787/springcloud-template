package com.company.order.wx.pay.controller;
...
//  @ApiOperation(value = "统一下单，并组装所需支付参数")
  ...
  public <T> T createOrder(@RequestBody WxPayUnifiedOrderRequest request) throws WxPayException {
	  WxPayUnifiedOrderResult createOrder22 = this.wxService.createOrder(new WxPayUnifiedOrderRequest());
	  
	  WxPayAppOrderResult createOrder = this.wxService.createOrder(new WxPayUnifiedOrderRequest());
	  WxPayMpOrderResult createOrder2 = this.wxService.createOrder(new WxPayUnifiedOrderRequest());
	  WxPayMwebOrderResult createOrder3 = this.wxService.createOrder(new WxPayUnifiedOrderRequest());
	  WxPayNativeOrderResult createOrder4 = this.wxService.createOrder(new WxPayUnifiedOrderRequest());
