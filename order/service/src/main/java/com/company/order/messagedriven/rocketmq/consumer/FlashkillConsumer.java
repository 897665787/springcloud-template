...
@RocketMQMessageListener(
        ...
        consumerGroup = Constants.QUEUE.FLASH_KILL.NAME,
        selectorType = SelectorType.TAG,
        selectorExpression = Constants.QUEUE.FLASH_KILL.KEY
)
@Slf4j
@Conditional(RocketMQAutoConfiguration.RocketMQCondition.class)
public class FlashkillConsumer implements RocketMQListener<MessageExt> {
    @Override
