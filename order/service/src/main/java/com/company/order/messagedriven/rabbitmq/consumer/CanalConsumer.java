...
public class CanalConsumer {
	...
	@RabbitListener(bindings = @QueueBinding(value = @Queue(value = FanoutConstants.CANAL.ORDER_QUEUE, durable = "false", autoDelete = "true"), exchange = @Exchange(value = FanoutConstants.CANAL.EXCHANGE, type = ExchangeTypes.FANOUT, durable = "false", autoDelete = "true")))
