...
import com.company.order.pay.aliactivity.dto.ActivityAppendedBizContent;
 ...
 * <pre>
 * 券活动预算追加通知
 * 官方文档：https://opendocs.alipay.com/pre-open/02cqrv
 * </pre>
 */
@Slf4j
...
public class AlipayMarketingActivityAppendedMessage implements FromMessage {
	...
	public void handle(Integer payNotifyId, Map<String, String> aliParams) {
		 ...
		 * </pre>
		 */
		ActivityAppendedBizContent bizContentObj = JsonUtil.toEntity(bizContent, ActivityAppendedBizContent.class);
