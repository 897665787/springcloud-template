...
import com.company.order.pay.aliactivity.dto.ActivityModifiedBizContent;
 ...
 * <pre>
 * 券活动修改通知
 * 官方文档：https://opendocs.alipay.com/pre-open/02cvz4
 * </pre>
 */
@Slf4j
@Component(FromMessageBeanFactory.MESSAGE_MODIFIED)
@RequiredArgsConstructor
public class AlipayMarketingActivityModifiedMessage implements FromMessage {
	...
	public void handle(Integer payNotifyId, Map<String, String> aliParams) {
		 ...
		 * </pre>
		 */
		ActivityModifiedBizContent bizContentObj = JsonUtil.toEntity(bizContent, ActivityModifiedBizContent.class);
